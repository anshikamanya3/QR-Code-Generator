...
class Qr_Generator:
    def __init__(self,root):
        ...
        self.root.title("Qr Generator | Developed by Anshika")
        ...
        lbl_course=Label(stu_Frame,text="Course",font=("times new roman",15 ,'bold'),bg='white').place(x=20,y=140)
        lbl_department=Label(stu_Frame,text="Department",font=("times new roman",15 ,'bold'),bg='white').place(x=20,y=180)

        txt_stu_code=Entry(stu_Frame,font=("times new roman",15),textvariable=self.var_stu_code,bg='lightblue').place(x=200,y=60)
        txt_name=Entry(stu_Frame,font=("times new roman",15),textvariable=self.var_name,bg='lightblue').place(x=200,y=100)
        txt_course=Entry(stu_Frame,font=("times new roman",15),textvariable=self.var_course,bg='lightblue').place(x=200,y=140)
        txt_department=Entry(stu_Frame,font=("times new roman",15),textvariable=self.var_department,bg='lightblue').place(x=200,y=180)
        ...
        btn_clear=Button(stu_Frame,text='Clear',command=self.clear,font=("times new roman",18,'bold'),bg='#607d8b',fg='white').place(x=282,y=250,width=120,height=30)
    ...
    def generate(self):
        if self.var_department.get()=='' or self.var_stu_code.get()=='' or self.var_course.get()=='' or self.var_name.get()=='':
